...
# Here the value of a and b is string type 
a = "1"
b = "5"

# it will give output as 15 because it is concationg two strings  not adding two numbers
print(a+b)

# here first we are Type Casting string to integer so final output will be 6
print( int(a)+int(b))
